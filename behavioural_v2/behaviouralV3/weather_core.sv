...
// nStart is no longer connected here -- main_fsm decodes it into clear_rain_pulse
// (which is mode-aware: only fires in MODE_RAIN), removing the previously
// duplicated debounce inside rain_gauge.
rain_gauge RAIN(
  .Clock,
  .nReset,
  .clear_pulse          (clear_rain_pulse),
  .nRain,
  .total_rain_pulses,
  .rain_hundreds_bcd,
  .rain_tens_bcd,
...
//==========================================================
// Elapsed time slots: "HH:MM" (Demo speed-up handled in clock_divider)
//==========================================================
...
//==========================================================
// Time-of-day slots: "HH:MM:SS" (Demo speed-up handled in clock_divider)
//==========================================================
