...
// Time of Day: HH:MM:SS, 24-hour roll-over.
// Demo speed-up is handled exclusively in clock_divider.sv (tick_1Hz runs
// at 60 Hz in Demo). This module just consumes tick_1Hz and is unaware
// of the Demo signal.
