...
//
// In Demo mode tick_1Hz runs at 60 Hz, so the internal counter's
// "minutes" field advances once per real second and its "hours"
// field advances once per real minute. Displaying et_hour:et_min
// therefore yields the spec-required MM:SS visual at 60x speed.
//==========================================================
