...
module clock_divider (
    ...
    output logic tick_1Hz   // 1Hz (60Hz in Demo mode -> 60x speed-up)
);
    ...
    // Demo mode: 60x speed-up per spec. With CLK_HZ=32768, 32768/60 rounds to 546,
    // giving an effective tick of ~60.015 Hz (well within demo accuracy).
    localparam int unsigned DIV_DEMO = (CLK_HZ >= 60) ? ((CLK_HZ + 30) / 60) : 1;
