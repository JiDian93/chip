...
// RTL (behavioural/weather.sv, weather_core.sv) always includes SDO, Test, SDI, ScanEnable.
// system/system.sv (do not edit) only connects .ScanEnable when scan_enable is defined:
`define scan_enable
