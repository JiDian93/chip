...
module wind_vane_adc (
  ...
  function automatic logic [11:0] adc_for_dir(input logic [3:0] d);
    case (d)
      ...
      4'd1:  adc_for_dir = 12'd1624;  // NNE
      4'd2:  adc_for_dir = 12'd1845;  // NE
      4'd3:  adc_for_dir = 12'd335;   // ENE
      4'd4:  adc_for_dir = 12'd372;   // E
      4'd5:  adc_for_dir = 12'd264;   // ESE
      4'd6:  adc_for_dir = 12'd739;   // SE
      4'd7:  adc_for_dir = 12'd506;   // SSE
      4'd8:  adc_for_dir = 12'd1149;  // S
      4'd9:  adc_for_dir = 12'd979;   // SSW
      4'd10: adc_for_dir = 12'd2521;  // SW
      4'd11: adc_for_dir = 12'd2398;  // WSW
      4'd12: adc_for_dir = 12'd3781;  // W
      4'd13: adc_for_dir = 12'd3310;  // WNW
      4'd14: adc_for_dir = 12'd3549;  // NW
      4'd15: adc_for_dir = 12'd2811;  // NNW
