    ...
    always_comb begin
        ...
        case (current_state)
            ...
            MODE_RAIN_CALIB: begin
                ...
                is_rain_calib     = 1'b1;
                display_mode      = 3'd0;
                calib_digit_index = 2'd3 - sub_state_counter;
            ...
            MODE_TIME_SETTING: begin
                ...
                case (sub_state_counter)
                    2'd0: if (start_pressed_single)
                              time_increment_pulse = 1'b1;
                    2'd1: if (start_pressed_single)
                              time_increment_pulse = 1'b1;
                    2'd2: if (start_pressed_single)
