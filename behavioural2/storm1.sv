...
// 在 handin 版本基础上扩展雨量与模式切换，同时保持原有风速 / 气压 / 温度波形。
  ...
  initial
    begin
      ...
      // very rapid drop in pressure (about 4 mbar)
      while (SENSOR.pressure > 1011.8)
  ...
  // ================================================================
  // 按键刺激：遍历所有 7 个模式，并在雨量 / 时间模式下使用 Start/Adjust 清零
  // ================================================================
