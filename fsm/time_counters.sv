...
// - time_set_field: 0=Set Hours, 1=Set Minutes, 2=Zero Seconds
// - time_increment_pulse: when in Set Hours/Set Minutes, increment that field
// - time_zero_seconds_pulse: when in Set Seconds, set seconds to 00
//==============================================================================
